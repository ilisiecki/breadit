...
import ToFeedButton from "@/components/shared/to-feed-button";
import SubscribeLeaveToggle from "@/components/shared/subscribe-leave-toggle";
...
export default async function SlugLayout({
  ...
  return (
    <div className="mx-auto h-full max-w-7xl px-2 pt-12 sm:container">
      <div>
        <ToFeedButton />
